package com.example.transportfirm.controller.dispatcher;
...
import com.example.transportfirm.service.dispatcher.DispatcherDocumentService;
import com.example.transportfirm.service.dispatcher.DispatcherService;
...
public class DispatcherController {
    ...
    public List<TruckGroup> myGroups(Principal principal) {
        DispatcherInfo dispatcher = dispatcherService.getByEmployeeEmail(principal.getName());
        return truckGroupService.getDispatcherGroups(dispatcher.getId());
    }
