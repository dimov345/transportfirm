...
public enum DispatcherDocumentType {
    ...
    CERTIFICATION,                  // Сертификат / квалификация
    TRAINING_CERTIFICATE,           // Сертификат от курс / обучение

    // Медицински
    MEDICAL_CERTIFICATE,            // Медицинско свидетелство
